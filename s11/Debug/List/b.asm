...
; 0000 006B // RS - PORTA Bit 0
; 0000 006C // RD - PORTA Bit 1
; 0000 006D // EN - PORTA Bit 2
; 0000 006E // D4 - PORTA Bit 4
; 0000 006F // D5 - PORTA Bit 5
; 0000 0070 // D6 - PORTA Bit 6
; 0000 0071 // D7 - PORTA Bit 7
; 0000 0072 // Characters/line: 20
; 0000 0073 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 0074 define_char(char0,0);
...
_0x6:
; 0000 007E       {
; 0000 007F          for(k=0; k<=9; k++)   //raftan ta nesf
	CLR  R8
	CLR  R9
_0xA:
	LDI  R30,LOW(9)
	...
	BRLT _0xB
; 0000 0080           {
; 0000 0081             for(j=1; j<=4; j++) // j az 1 ta 4, baraye har j adadi ro LCD namayesh midim
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	MOVW R6,R30
_0xD:
	...
	BRLT _0xE
; 0000 0082              {
; 0000 0083                for(i=0; i<=1; i++)// i az 0 ta 1, baraye har i khat LCD ro entekhab mikonim
	CLR  R4
	CLR  R5
_0x10:
	LDI  R30,LOW(1)
	...
	BRLT _0x11
; 0000 0084                 {
; 0000 0085                   lcd_gotoxy(k,i);
	RCALL SUBOPT_0x0
; 0000 0086                   lcd_putchar(j);
; 0000 0087                   lcd_gotoxy(19-k,i);
; 0000 0088                   lcd_putchar(8-j);
; 0000 0089                 }
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
...
_0x19:
	...
	BRLT _0x1A
; 0000 0093                 {
; 0000 0094                   lcd_gotoxy(k,i);
	RCALL SUBOPT_0x0
; 0000 0095                   lcd_putchar(j);
; 0000 0096                   lcd_gotoxy(19-k,i);
; 0000 0097                   lcd_putchar(8-j);
; 0000 0098                 }
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
