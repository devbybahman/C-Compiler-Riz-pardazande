...
; 0000 0094 // Characters/line: 20
; 0000 0095 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 0096 DDRC = 0x0F;
	LDI  R30,LOW(15)
	OUT  0x14,R30
; 0000 0097 PORTC = 0xF0;
	LDI  R30,LOW(240)
	OUT  0x15,R30
; 0000 0098 
; 0000 0099 while (1)
...
; 0000 009E     PORTC.3 = 1;
	SBI  0x15,3
; 0000 009F 
; 0000 00A0     if (PINC.4 == 0 && PINC.5 == 1 && PINC.6 == 1 && PINC.7 == 1)
	SBIC 0x13,4
	RJMP _0xF
	SBIS 0x13,5
	RJMP _0xF
...
; 0000 00A2         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00A3         lcd_putsf("7");
	__POINTW2FN _0x0,0
	RCALL SUBOPT_0x1
; 0000 00A4         delay_ms(50);
; 0000 00A5     }
; 0000 00A6 
; 0000 00A7     if (PINC.4 == 1 && PINC.5 == 0 && PINC.6 == 1 && PINC.7 == 1)
_0xE:
	SBIS 0x13,4
	RJMP _0x12
	SBIC 0x13,5
...
; 0000 00A9         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00AA         lcd_putsf("8");
	__POINTW2FN _0x0,2
	RCALL SUBOPT_0x1
; 0000 00AB         delay_ms(50);
; 0000 00AC     }
; 0000 00AD 
; 0000 00AE     if (PINC.4 == 1 && PINC.5 == 1 && PINC.6 == 0 && PINC.7 == 1)
_0x11:
	SBIS 0x13,4
	RJMP _0x15
	SBIS 0x13,5
...
; 0000 00B0         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00B1         lcd_putsf("9");
	__POINTW2FN _0x0,4
	RCALL SUBOPT_0x1
; 0000 00B2         delay_ms(50);
; 0000 00B3     }
; 0000 00B4 
; 0000 00B5     if (PINC.4 == 1 && PINC.5 == 1 && PINC.6 == 1 && PINC.7 == 0)
_0x14:
	SBIS 0x13,4
	RJMP _0x18
	SBIS 0x13,5
...
; 0000 00BF     PORTC.3 = 1;
	SBI  0x15,3
; 0000 00C0 
; 0000 00C1     if (PINC.4 == 0 && PINC.5 == 1 && PINC.6 == 1 && PINC.7 == 1)
	SBIC 0x13,4
	RJMP _0x23
	SBIS 0x13,5
	RJMP _0x23
...
; 0000 00C3         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00C4         lcd_putsf("4");
	__POINTW2FN _0x0,8
	RCALL SUBOPT_0x1
; 0000 00C5         delay_ms(50);
; 0000 00C6     }
; 0000 00C7 
; 0000 00C8     if (PINC.4 == 1 && PINC.5 == 0 && PINC.6 == 1 && PINC.7 == 1)
_0x22:
	SBIS 0x13,4
	RJMP _0x26
	SBIC 0x13,5
...
; 0000 00CA         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00CB         lcd_putsf("5");
	__POINTW2FN _0x0,10
	RCALL SUBOPT_0x1
; 0000 00CC         delay_ms(50);
; 0000 00CD     }
; 0000 00CE 
; 0000 00CF     if (PINC.4 == 1 && PINC.5 == 1 && PINC.6 == 0 && PINC.7 == 1)
_0x25:
	SBIS 0x13,4
	RJMP _0x29
	SBIS 0x13,5
...
; 0000 00D1         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00D2         lcd_putsf("6");
	__POINTW2FN _0x0,12
	RCALL SUBOPT_0x1
; 0000 00D3         delay_ms(50);
; 0000 00D4     }
; 0000 00D5 
; 0000 00D6     if (PINC.4 == 1 && PINC.5 == 1 && PINC.6 == 1 && PINC.7 == 0)
_0x28:
	SBIS 0x13,4
	RJMP _0x2C
	SBIS 0x13,5
...
; 0000 00E0     PORTC.3 = 1;
	SBI  0x15,3
; 0000 00E1 
; 0000 00E2     if (PINC.4 == 0 && PINC.5 == 1 && PINC.6 == 1 && PINC.7 == 1)
	SBIC 0x13,4
	RJMP _0x37
	SBIS 0x13,5
	RJMP _0x37
...
; 0000 00E4         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00E5         lcd_putsf("1");
	__POINTW2FN _0x0,16
	RCALL SUBOPT_0x1
; 0000 00E6         delay_ms(50);
; 0000 00E7     }
; 0000 00E8 
; 0000 00E9     if (PINC.4 == 1 && PINC.5 == 0 && PINC.6 == 1 && PINC.7 == 1)
_0x36:
	SBIS 0x13,4
	RJMP _0x3A
	SBIC 0x13,5
...
; 0000 00EB         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00EC         lcd_putsf("2");
	__POINTW2FN _0x0,18
	RCALL SUBOPT_0x1
; 0000 00ED         delay_ms(50);
; 0000 00EE     }
; 0000 00EF 
; 0000 00F0     if (PINC.4 == 1 && PINC.5 == 1 && PINC.6 == 0 && PINC.7 == 1)
_0x39:
	SBIS 0x13,4
	RJMP _0x3D
	SBIS 0x13,5
...
; 0000 00F2         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 00F3         lcd_putsf("3");
	__POINTW2FN _0x0,20
	RCALL SUBOPT_0x1
; 0000 00F4         delay_ms(50);
; 0000 00F5     }
; 0000 00F6 
; 0000 00F7     if (PINC.4 == 1 && PINC.5 == 1 && PINC.6 == 1 && PINC.7 == 0)
_0x3C:
	SBIS 0x13,4
	RJMP _0x40
	SBIS 0x13,5
...
; 0000 0101     PORTC.3 = 0;
	CBI  0x15,3
; 0000 0102 
; 0000 0103     if (PINC.4 == 0 && PINC.5 == 1 && PINC.6 == 1 && PINC.7 == 1)
	SBIC 0x13,4
	RJMP _0x4B
	SBIS 0x13,5
	RJMP _0x4B
...
; 0000 0107     }
; 0000 0108 
; 0000 0109     if (PINC.4 == 1 && PINC.5 == 0 && PINC.6 == 1 && PINC.7 == 1)
_0x4A:
	SBIS 0x13,4
	RJMP _0x4E
	SBIC 0x13,5
...
; 0000 010B         lcd_gotoxy(0, 0);
	RCALL SUBOPT_0x0
; 0000 010C         lcd_putsf("0");
	__POINTW2FN _0x0,24
	RCALL SUBOPT_0x1
; 0000 010D         delay_ms(50);
; 0000 010E     }
; 0000 010F 
; 0000 0110     if (PINC.4 == 1 && PINC.5 == 1 && PINC.6 == 0 && PINC.7 == 1)
_0x4D:
	SBIS 0x13,4
	RJMP _0x51
	SBIS 0x13,5
...
; 0000 0115     }
; 0000 0116 
; 0000 0117     if (PINC.4 == 1 && PINC.5 == 1 && PINC.6 == 1 && PINC.7 == 0)
_0x50:
	SBIS 0x13,4
	RJMP _0x54
	SBIS 0x13,5
