...
; 0000 002D DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(248)
	OUT  0x17,R30
; 0000 002E // State: ÈÇ Pull-up ÈÑÇí ÓæÆíåÇ
; 0000 002F PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(7)
	OUT  0x18,R30
; 0000 0030 
...
; 0000 0039 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(15)
	OUT  0x11,R30
...
; 0000 009C               data=PINB;
	IN   R4,22
	CLR  R5
; 0000 009D          data= data & 0x03;
	LDI  R30,LOW(3)
	AND  R4,R30
	CLR  R5
; 0000 009E          switch(data){
	MOVW R30,R4
; 0000 009F           case 0:PORTD=0b00000001;break;
	SBIW R30,0
	BRNE _0xA
	LDI  R30,LOW(1)
	RJMP _0xF
; 0000 00A0           case 1:PORTD=0b00000010;break;
_0xA:
	CPI  R30,LOW(0x1)
	LDI  R26,HIGH(0x1)
	CPC  R31,R26
	...
	LDI  R30,LOW(2)
	RJMP _0xF
; 0000 00A1           case 2:PORTD=0b00000100;break;
_0xB:
	CPI  R30,LOW(0x2)
	LDI  R26,HIGH(0x2)
	CPC  R31,R26
	...
	LDI  R30,LOW(4)
	RJMP _0xF
; 0000 00A2           case 3:PORTD=0b00001000;break;
_0xC:
	CPI  R30,LOW(0x3)
	LDI  R26,HIGH(0x3)
	CPC  R31,R26
