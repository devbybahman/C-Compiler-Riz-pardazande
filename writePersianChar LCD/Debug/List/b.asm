...
_char0:
	.DB  0x0,0x0,0x0,0x0,0x2,0x4,0x8,0x0
_char1:
	.DB  0x0,0x4,0x0,0x2,0x1E,0x0,0x0,0x0
_char2:
	.DB  0x0,0x0,0xE,0x2,0x1E,0x0,0x4,0x0
_char3:
	.DB  0x0,0x0,0x0,0x2,0x1E,0x0,0x4,0x0
_char4:
	.DB  0x0,0x0,0x0,0x0,0x2,0x4,0x8,0x0
...
;flash byte char0[8]={0b00000000,0b00000000,0b00000000,0b00000000,0b00000010,0b00000100,0b00001000,0b00000000};
;flash byte char1[8]={0b00000000,0b00000100,0b00000000,0b00000010,0b00011110,0b00000000,0b00000000,0b00000000};
;flash byte char2[8]={0b00000000,0b00000000,0b00001110,0b00000010,0b00011110,0b00000000,0b00000100,0b00000000};
;flash byte char3[8]={0b00000000,0b00000000,0b00000000,0b00000010,0b00011110,0b00000000,0b00000100,0b00000000};
;flash byte char4[8]={0b00000000,0b00000000,0b00000000,0b00000000,0b00000010,0b00000100,0b00001000,0b00000000};
;
;
...
; 0000 00AF lcd_gotoxy(0,0);
	...
	RCALL _lcd_gotoxy
; 0000 00B0 
; 0000 00B1 lcd_putchar(4);
	LDI  R26,LOW(4)
	RCALL _lcd_putchar
; 0000 00B2 lcd_putchar(3);
	LDI  R26,LOW(3)
	RCALL _lcd_putchar
; 0000 00B3 lcd_putchar(2);
	LDI  R26,LOW(2)
	RCALL _lcd_putchar
; 0000 00B4 lcd_putchar(1);
	LDI  R26,LOW(1)
	RCALL _lcd_putchar
