...
; 0000 002D DDRB = (1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(240)
	OUT  0x17,R30
; 0000 002E // State: ÈÇ Pull-up ÈÑÇí ÓæÆíåÇ (íä 0-3 æÑæÏí ÈÇ Pull-up)
; 0000 002F PORTB = (0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(15)
	OUT  0x18,R30
; 0000 0030 
...
_0x3:
; 0000 0099       {
; 0000 009A       //Enable (Active High)
; 0000 009B         if(PINB.3==1){
	SBIS 0x16,3
	RJMP _0x6
; 0000 009C 
; 0000 009D 
; 0000 009E         data=PINB;
	IN   R4,22
	CLR  R5
; 0000 009F         // masc kardan 3 bit aval
; 0000 00A0          data= data & 0x07;//masc 3 bit aval
	LDI  R30,LOW(7)
	AND  R4,R30
	CLR  R5
; 0000 00A1          switch(data)
	MOVW R30,R4
; 0000 00A2             {
; 0000 00A3                 case 0: PORTD = 0b11111110; break;  // Y0 active
	SBIW R30,0
	BRNE _0xA
	LDI  R30,LOW(254)
	RJMP _0x14
; 0000 00A4                 case 1: PORTD = 0b11111101; break;  // Y1 active
_0xA:
	CPI  R30,LOW(0x1)
	LDI  R26,HIGH(0x1)
	CPC  R31,R26
	...
	LDI  R30,LOW(253)
	RJMP _0x14
; 0000 00A5                 case 2: PORTD = 0b11111011; break;  // Y2 active
_0xB:
	CPI  R30,LOW(0x2)
	LDI  R26,HIGH(0x2)
	CPC  R31,R26
	...
	LDI  R30,LOW(251)
	RJMP _0x14
; 0000 00A6                 case 3: PORTD = 0b11110111; break;  // Y3 active
_0xC:
	CPI  R30,LOW(0x3)
	LDI  R26,HIGH(0x3)
	CPC  R31,R26
	...
	LDI  R30,LOW(247)
	RJMP _0x14
; 0000 00A7                 case 4: PORTD = 0b11101111; break;  // Y4 active
_0xD:
	CPI  R30,LOW(0x4)
	LDI  R26,HIGH(0x4)
	CPC  R31,R26
	...
	LDI  R30,LOW(239)
	RJMP _0x14
; 0000 00A8                 case 5: PORTD = 0b11011111; break;  // Y5 active
_0xE:
	CPI  R30,LOW(0x5)
	LDI  R26,HIGH(0x5)
	CPC  R31,R26
	...
	LDI  R30,LOW(223)
	RJMP _0x14
; 0000 00A9                 case 6: PORTD = 0b10111111; break;  // Y6 active
_0xF:
	CPI  R30,LOW(0x6)
	LDI  R26,HIGH(0x6)
	CPC  R31,R26
	...
	LDI  R30,LOW(191)
	RJMP _0x14
; 0000 00AA                 case 7: PORTD = 0b01111111; break;  // Y7 active
_0x10:
	CPI  R30,LOW(0x7)
	LDI  R26,HIGH(0x7)
	CPC  R31,R26
...
_0x6:
; 0000 00AE         {
; 0000 00AF             // E=1 DeActive
; 0000 00B0             PORTD = 0b11111111;
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 00B1         }
_0x12:
