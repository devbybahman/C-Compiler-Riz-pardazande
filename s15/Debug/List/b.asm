...
;#include <mega16.h>
	...
	#endif
;flash unsigned char number []={0x3f ,0x06 ,0x5b ,0x4f ,0x66,0x6d ,0x7d ,0x07 ,0x7f ,0x6f };
;unsigned char i=0;
;
...
; .FSTART _ext_int0_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0021     if (i<9) PORTA=number[++i];
	LDI  R30,LOW(9)
	CP   R5,R30
	BRSH _0x3
	INC  R5
	RCALL SUBOPT_0x0
; 0000 0022     while(PIND.2==0);
_0x3:
_0x4:
	SBIS 0x10,2
	RJMP _0x4
...
; .FSTART _ext_int1_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0029    if (i>0) PORTA=number[--i];
	LDI  R30,LOW(0)
	CP   R30,R5
	BRSH _0x7
	DEC  R5
	RCALL SUBOPT_0x0
; 0000 002A    while(PIND.3==0)  ;
_0x7:
_0x8:
	SBIS 0x10,3
	RJMP _0x8
...
; 0000 007B // INT1: On
; 0000 007C // INT1 Mode: Falling Edge
; 0000 007D // INT2: Off
; 0000 007E GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 007F MCUCR=(1<<ISC11) | (0<<ISC10) | (1<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(10)
	OUT  0x35,R30
